...
const TransactionCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount, url }) => {
    ...
    const gifUrl = useFetch({ keyword: keyword }) || null
    // console.log(gifUrl);

    return (
        <div className="bg-[#181918] m-4 flex flex-1 2xl:min-w-[450px] 2xl:max-w-[500px] sm:min-w-[270px] sm:max-w-[300px] flex-col rounded-md hover:shadow-2xl">
            <div className="flex flex-col items-center w-full mt-3 pb-2">
        ...
        <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
            <div className="flex flex-col md:p-12 py-12 px-4">
                ...
                <div className="flex flex-wrap justify-center items-center mt-10">
                    {transactions.slice().reverse().map((transaction, ind) => (
